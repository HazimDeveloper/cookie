...
$select_cookie = mysqli_query($conn,"SELECT * FROM cookie");

$data_cookie =  mysqli_fetch_assoc($select_cookie);
        ...
        <header class="header" id="header">
            <nav class="nav container">
                <a href="#" class="nav__logo">
                    <i class='bx bxs-cookie nav__logo-icon'></i> Cookie
                </a>
        ...
        <main class="main">
            ...
            <section class="home" id="home">
                <div class="home__container container grid">
                    <div class="home__img-bg" style="background-color: purple;">
                        <img src="assets/img/<?= $data_cookie['img_cookie'] ?>" alt="" class="home__img">
                    </div>
                    ...
                    <div class="home__data">
                        <h1 class="home__title">NEW COOKIE <br> COLLECTIONS 2023</h1>
                        <p class="home__description"><?= $data_cookie['detail_cookie'] ?>
                        </p>
                        <span class="home__price" style="color:purple">RM <?= $data_cookie['price_cookie'] ?>/kg</span>
                        ...
                        <div class="home__btns">
                            ...
                            <a href="" class="button home__button">ADD TO CART</a>
                            <a href="ingredient.php?id_cookie=<?= $data_cookie['id_cookie'] ?>" class="button home__button">SEE INGREDIENT</a>
            ...
            <!-- <section class="featured section container" id="featured">
                ...
                <div class="featured__container grid">
                    <?php while($res_cookie = mysqli_fetch_assoc($select_cookie)) { ?>
                    <article class="featured__card">
                        <span class="featured__tag">Sale</span>

                        <img src="assets/img/<?= $data_cookie['img_cookie'] ?>" alt="" class="featured__img">

                        <div class="featured__data">
                            <h3 class="featured__title"><?= $res_cookie['name_cookie'] ?></h3>
                            <span class="featured__price">RM <?= $res_cookie['price_cookie'] ?>/kg</span>
                        </div>

                        <a href="" class="button featured__button">ADD TO CART</a>
                ...
                <div class="story__container grid">
                    <div class="story__data">
                        ...
                        <p class="story__description">
                          This Company already sell the cookies from 2015
                        </p>
                    ...
                    <div class="story__images" >
                        <img src="assets/img/cookie.png" alt="" class="story__img" style="position:absolute;left:10px;top:5px">
                        <div style="background-color: purple;" class="story__square"></div>
                    </div>
                </div>
            </section>
