    ...
    <body>
            ...
            <nav class="nav container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item">
                            <a href="product.php" class="nav__link active-link">Products</a>
                        </li>
                        <li class="nav__item">
     ...
     -->
                    <!-- <div class="home__data">
                        ...
                        <span class="home__price">RM <?= $data_cookie['price_cookie'] ?>/kg</span>
                        ...
                        <div class="home__btns">
                            ...
                            <a href="<?= $data_cookie['id_cookie'] ?>" class="button home__button">ADD TO CART</a>
            ...
            <section class="featured section container" id="featured">
                ...
                <div class="featured__container grid">
                    ...
                    <article class="featured__card">
                        ...
                        <img src="assets/img/<?= $res_cookie['img_cookie'] ?>" alt="" class="featured__img">
                        ...
                        <a href="ingredient.php?id_cookie=<?= $res_cookie['id_cookie'] ?>" class="button featured__button">SEE INGREDIENT</a>
